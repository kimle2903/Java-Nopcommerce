...
public class ExtentManager {
	...
	public synchronized static ExtentReports createExtentReports() {
		System.out.println(GlobalConstants.PROJECT_PATH + "extentV5/ExtentReport.html");
		...
		extentReports.setSystemInfo("Company", "CUM CUM");
		extentReports.setSystemInfo("Project", "NopCommerce");
		extentReports.setSystemInfo("Team", "CUM");
